...
from pretrain.prototype.dataloader_nuscenes_cluster_cylinder3d import NuScenesDatasetCylinder3d, cylinder3d_custom_collate_fn
...
class PretrainDataModule(pl.LightningDataModule):
    def __init__(self, config):
        ...
        self.model_point_name = self.config["model_points"]
    ...
    def setup(self, stage):
        ...
        assert self.config["dataset"].lower() == "nuscenes"
